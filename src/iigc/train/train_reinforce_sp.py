...
Uses obs_utils for any-player observation â€?enables true self-play.
"""
...
def run_episode_masked(game, policy, agent_id, partner_seed):
    """Run episode for kappa eval â€?deterministic, fixed seed."""
...
if __name__ == '__main__':
    ...
    for mode in MODES:
        ...
        for seed in SEEDS:
            ...
            print(f'SP {mode} s{seed}: Îº={k:.4f} rA={ra:.2f} rB={rb:.2f}')
